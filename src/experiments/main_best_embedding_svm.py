...
for i in range(len(DATA_LIST)):
    ...
    test_metrics_file_name = os.path.join(experiment_folder, f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_cv_{MODEL_TYPE}.csv")
    metrics_statistics_file_name = os.path.join(experiment_folder, f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_cv_{MODEL_TYPE}_stats.csv")
    ...
    test_metrics_file_name = os.path.join(experiment_folder, f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_tfidf_{MODEL_TYPE}.csv")
    metrics_statistics_file_name = os.path.join(experiment_folder, f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_tfidf_{MODEL_TYPE}_stats.csv")
    create_metrics_df(NUM_SAMPLES, metrics_list, test_metrics_file_name, metrics_statistics_file_name)
    ...
    test_metrics_file_name = os.path.join(experiment_folder, f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_word2vec_{MODEL_TYPE}.csv")
    metrics_statistics_file_name = os.path.join(experiment_folder,
                                                f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_word2vec_{MODEL_TYPE}_stats.csv")
    create_metrics_df(NUM_SAMPLES, metrics_list, test_metrics_file_name, metrics_statistics_file_name)
    ...
    test_metrics_file_name = os.path.join(experiment_folder, f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_lda_{MODEL_TYPE}.csv")
    metrics_statistics_file_name = os.path.join(experiment_folder,
                                                f"best_embedding_{MODEL_TYPE}_" + DATASET_NAMES[i] + f"_lda_{MODEL_TYPE}_stats.csv")
    create_metrics_df(NUM_SAMPLES, metrics_list, test_metrics_file_name, metrics_statistics_file_name)
